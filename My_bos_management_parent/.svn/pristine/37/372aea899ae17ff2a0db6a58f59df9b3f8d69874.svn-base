...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//导出按钮绑定的事件
			function doExport(){
				location.href="${pageContext.request.contextPath}/subArea_exportSubArea.action";
			}
			...
			function doShowChart(){
				...
				$.post(
					"${pageContext.request.contextPath}/subArea_showSubareaChart.action",
					function(data){
			...
			$(function(){
				...
				$('#grid').datagrid( {
					...
					pagination : true,
					toolbar : toolbar,
					url : "${pageContext.request.contextPath}/subArea_findPage.action",
					idField : 'id',
					columns : columns,
