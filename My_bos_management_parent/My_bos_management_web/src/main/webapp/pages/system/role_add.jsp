...
<html>
	<head>
		...
		<script type="text/javascript">
			$(function(){
				...
				$.ajax({
					url : '${pageContext.request.contextPath}/menu_findSimpleTree.action',
					type : 'POST',
					dataType : 'json',
				...
				$.post(
					"${pageContext.request.contextPath}/permission_findAll.action",
					function(data){
						for(var i=0;i<data.length;i++){
							$("#permissionList").append("<input type='checkbox' name='permissionIds' id='"+data[i].id+"' value='"+data[i].id+"' />"+"<label for='"+data[i].id+"'>"+data[i].name+"</label>");
						}
					}
				);
	...
	<body class="easyui-layout">
		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form action="${pageContext.request.contextPath}/role_save.action" id="roleForm" method="post">
				<table class="table-edit" width="80%" align="center">
					<input type="text" id="menuIds" name="menuIds"  />
					<tr class="title">
